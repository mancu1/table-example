# Табличный редактор с разреженным хранением
...
- **Диапазоны**: =SUM(A1:C3) с автоматическим расширением при вставке
...
- `=SUM(A1:C3)` - сумма диапазона (расширяется при вставке внутрь)
